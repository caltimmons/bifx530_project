...
insert into login(login_id, employee_id, password) values(”hford”, 30000001, ”password2”);
insert into login(login_id, employee_id, password) values(”jboyega”, 30000002, ”password3”);
insert into login(login_id, employee_id, password) values(”dridley”, 30000003, ”password4”);
insert into login(login_id, employee_id, password) values(”adriver”, 30000004, ”password5”);
insert into login(login_id, employee_id, password) values(”mhamill”, 30000005, ”password6”);
insert into login(login_id, employee_id,password) values(”jjones”, 30000006, ”password7”);
insert into login(login_id, employee_id,password) values(”jdoe”, 30000007, ”password8”);
insert into login(login_id, employee_id, password) values(”msmith”, 30000008, ”password9”);
insert into login(login_id, employee_id, password) values(”jolson”, 30000009, ”password10”);
insert into login(login_id, employee_id, password) values(”Ksmith”, 20000001, ”password11”);
insert into login(login_id, employee_id,password) values(”Jjonson”, 20000002, ”password12”);
insert into login(login_id, employee_id, password) values(”Mmiller”, 20000003, ”password13”);
insert into login(login_id, employee_id, password) values(”Rclark”, 20000004, ”password14”);
insert into login(login_id, employee_id, password) values(”Gdavis”, 20000005, ”password15”);
insert into login(login_id, employee_id, password) values(”Dwilson”, 20000006, ”password16”);
insert into login(login_id, employee_id, password) values(”Ktaylor”, 20000007, ”password17”);
insert into login(login_id, employee_id, password) values(”Tbrown”, 20000008, ”password18”);
insert into login(login_id, employee_id, password) values(”Cjones”,20000009, ”password19”);
insert into login(login_id, employee_id, password) values(”Mmiller”, 20000010, ”password20”);
